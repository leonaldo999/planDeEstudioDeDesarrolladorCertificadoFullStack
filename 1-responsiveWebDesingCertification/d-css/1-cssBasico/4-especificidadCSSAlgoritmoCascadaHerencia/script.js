...
function copiarCodigo(btn) {
  ...
  // Usamos innerText para copiar el código limpio (sin números de línea)
...
// ===============================================
// 3. MEJORAS DE CÓDIGO (Números de línea y Trim)
// ===============================================
...
function initializeEditor(container) {
  ...
  // 2. Generación de Números de Línea
